...
namespace EmployeeManagement.Presistance.IOC
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IIntegrationTradeRepository, IntegrationTradeRepository>();
            services.AddScoped<IIntegrationTradeService, IntegrationTradeService>();
            services.AddScoped<IIntegrationTradeFactory, IntegrationTradeFactory>();
